...
from PyQt5.QtGui import (QIcon, QFont, QFontMetrics, QPixmap, QCursor, QImage, QClipboard, QColor, QCloseEvent, QMouseEvent, QWheelEvent, QTextCursor, QDropEvent)
...
class ExportImport(QDialog):
    ...
    def _add_imported_file(self, data: dict, archive_content_path: str) -> bool:
        ...
        db_file.update_file(last_row_id, media_dict=file_dict)
