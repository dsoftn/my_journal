from PyQt5.QtWidgets import QFrame, QPushButton, QScrollArea, QWidget, QLabel, QLineEdit, QSizePolicy, QGridLayout
...
class AladinWE(AbstractTopic):
    ...
    def _populate_cards_dict(self, html: str = None):
        ...
        cards_htmls = self.html_parser.get_tags(html_code=html, tag="div", tag_class_contains="card border mb-3", multiline=True)
